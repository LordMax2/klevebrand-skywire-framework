...
SetApnHologramSkywireCommand<RxBufferSize>::SetApnHologramSkywireCommand(
...
template<size_t RxBufferSize>
SkywireResponseResult_t SetApnHologramSkywireCommand<RxBufferSize>::process()
{
...
template<size_t RxBufferSize>
void SetApnHologramSkywireCommand<RxBufferSize>::reset()
{
    _at.reset();
    _state = State::SendSet;
}
