...
public:
	...
	SkywireCommand(HardwareSerial *skywire, const __FlashStringHelper *command, bool debug_mode, OnCompletedFunction on_completed_function);
...
protected:
	virtual void writeCommandToModem();
};
